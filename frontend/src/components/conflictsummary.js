  ...
  const handleConfirmConflicts = async () => {
    try {
      ...
      const response = await api.post(
        "/notifications/create-noti/prog",
        payload,
      );
    ...
    <div className="notification-overlay" style={{ zIndex: 1000 }}>
      <div className="notification-content">
        ...
        <div className="notification-body">
          <p>
            The following study programs will be affected by term conflicts:
          </p>
          ...
          <p className="warning-text">
            Notifications will be sent to all affected programs. Do you want to
            continue?
          </p>
        </div>
        ...
        <div className="notification-actions">
          ...
          <button className="confirm-button" onClick={handleConfirmConflicts}>
            Confirm and Save
          </button>
        </div>
      </div>
